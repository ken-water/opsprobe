...
The `0.7.x` external-validation cycle is now complete. OpsProbe is now in the `0.9.x` service-depth line, with `0.9.0` focused on a deeper MySQL inspection workflow before declaring `1.0.0`.
