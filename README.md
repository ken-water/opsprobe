...
The `0.7.x` external-validation cycle is now complete. OpsProbe is in the `0.8.x` exploration line, with `0.8.3` now focused on functional coverage growth and release hardening before declaring `1.0.0`.
