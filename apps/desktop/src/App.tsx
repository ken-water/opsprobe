  ...
  return (
    <main className="app-shell">
      <section className="hero">
        ...
        <p className="summary">
          `0.8.2` continues the post-validation exploration line by making reports and remediation
          guidance more useful for recurring operational review.
        </p>
      </section>
      ...
      <section className="grid">
        ...
        <article className="card">
          ...
          <p className="version">v0.8.2</p>
          <ul>
            <li>Report usefulness improvements</li>
            <li>Recurring action visibility</li>
            <li>Third `0.8.x` exploration release</li>
          </ul>
        </article>
      ...
      <section className="run-panel">
        <div className="panel-header">
          <div>
            <p className="eyebrow">0.8.2 Current Release</p>
