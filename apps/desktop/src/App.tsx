  ...
  return (
    <main className="app-shell">
      <section className="hero">
        ...
        <p className="summary">
          `0.8.1` continues the post-validation exploration line by deepening Kubernetes node
          evidence while keeping the product local-first and inspection-quality focused.
        </p>
      </section>
      ...
      <section className="grid">
        <article className="card">
          <h2>Current Focus</h2>
          <ul>
            <li>Deeper Docker host inspection evidence</li>
            <li>Higher-quality service-role workflows</li>
            <li>Release-by-release `0.8.x` exploration checkpoints</li>
          </ul>
        </article>

        <article className="card">
          <h2>Current Release</h2>
          <p className="version">v0.8.1</p>
          <ul>
            <li>Kubernetes node workflow depth</li>
            <li>Pressure and kubelet health evidence</li>
            <li>Second `0.8.x` exploration release</li>
          </ul>
        </article>
      ...
      <section className="run-panel">
        <div className="panel-header">
          <div>
            <p className="eyebrow">0.8.1 Current Release</p>
