  ...
  return (
    <main className="app-shell">
      <section className="hero">
        ...
        <p className="summary">
          `0.8.3` closes the current `0.8.x` line by adding repeatable functional validation and
          stronger release gates around the local inspection workflow.
        </p>
      </section>
      ...
      <section className="grid">
        <article className="card">
          <h2>Current Focus</h2>
          <ul>
            <li>Repeatable local-service functional validation</li>
            <li>Release-candidate hardening before wider usage</li>
            <li>Stable `0.8.x` closeout instead of version churn</li>
          </ul>
        </article>

        <article className="card">
          <h2>Current Release</h2>
          <p className="version">v0.8.3</p>
          <ul>
            <li>CLI functional test coverage</li>
            <li>Smoke validation for asset-preview-report flow</li>
            <li>Fourth `0.8.x` exploration release</li>
          </ul>
        </article>
      ...
      <section className="run-panel">
        <div className="panel-header">
          <div>
            <p className="eyebrow">0.8.3 Current Release</p>
